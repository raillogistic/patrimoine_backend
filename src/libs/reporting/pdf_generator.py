...
class PdfGenerator:
    ...
    """
    OVERLAY_LAYOUT = '@page {size: A4 portrait; margin-left: 1cm;margin-top:0.5cm;margin-right:1cm}'

    def __init__(self, main_html, header_html=None, footer_html=None,
                 base_url=None, side_margin=2, extra_vertical_margin=30, annex=None):
        """
        Parameters
        ----------
        main_html: str
