...
class PdfGenerator:
    ...
    OVERLAY_LAYOUT = "@page {size: A4 portrait;padding:0; margin:0;}"
    ...
    def _compute_overlay_element(self, element: str):
        ...
        if element == "header":
            element_height = getattr(element_html, "height")
        if element == "footer":
    ...
    def render_pdf(self, annex_doc, no_margin=False):
        """
        Returns
        -------
        ...
        if no_margin:
            content_print_layout = "@page {size: A4 portrait; margin: 0px;}"
        else:
            content_print_layout = "@page {size: A4 portrait; margin: %s;}" % margins
